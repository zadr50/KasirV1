 ...
 */
public class WaitersList extends AppCompatActivity {
    ListView lv1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                myIntent4.setAction("com.talagasoft.admin.WaitersInput");
        ...
        txtTitle.setText("Waiter Number");
    ...
    private void loadData(){
        ...
        mBaseAdapter=new SqlAdapter(getBaseContext(), R.layout.list_row,
                controls, "select * from ksr_waiters");
